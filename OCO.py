...
threads = [32439, 32440, 32515, 32513, 32517, 32516]
...
users = ['Gragg9', 'bowl0', 'shrub02', 'speculadora', 'ReverendOReily', 'Nhamlet', 'Memento Mori', 'Thor', 'Blasoon', 'Gwdjohnson', 'rapideagle', 'SeymourSnatches', 'Revolution5', 'Suggs', 'Haseo', 'Dallypole', 'legion of slugs', 'Duilio05']

# users = [ If specifying a team, please use the following abbreviations and format
